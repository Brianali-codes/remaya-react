            ...
            <div id="LP">
                ...
                <div className="bg-transparent flex flex-row justify-center items-center " id='hero-section'>
                    ...
                    <div className='text-center w-3/6 p-5 home-desc'>
                        ...
                        <br />
                        <p className='desc text-2xl home-desc'>Being beneficiaries of AVSI and having experienced help from scratch while attending <span className='text-blue-400'> Cardinal Otunga School, </span>Lamas and Reshida was inspired to dive deeper into practical philanthropy and start REMAYA Org</p>
                        <br />
