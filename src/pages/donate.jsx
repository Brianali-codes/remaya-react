        ...
        <>
            ...
            <div className="h-screen flex flex-row justify-center items-center bg-white p-5" id="donation-container">
                ...
                <div className="w-3/6 flex flex-col justify-center items-start doncont">
                    ...
                    <p className="text-md desc"><span className="text-blue-500 font-bold desc">Why Donate to REMAYA Organization?</span> Your donations support education, gender equality, and outreach projects, empowering underprivileged communities. REMAYA provides comprehensive assistance to children, advocates for equal opportunities, and engages with vulnerable populations. Join us in fostering dignity, hope, and positive change locally and globally.
</p>
                </div>
                ...
                <div className="w-3/6 flex flex-col justify-center items-center p-3 doncont">
                    <div className="donation-box">
                        ...
                        <input type="text" className="don-input" placeholder="Add your amount." value={`Amount in $ : ${amount}`} />
                    ...
                    <p className="desc text-center">"Giving is more than just a donation; it's a powerful act of kindness that transforms lives and uplifts communities. Your generosity can bring hope, education, and empowerment to those in need, creating a ripple effect of positive change. Together, we can make a lasting difference."</p>
